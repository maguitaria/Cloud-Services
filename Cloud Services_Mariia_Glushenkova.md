...
9. **Major PaaS Platforms for Containers and Applications**
   ...
   - **IBM Cloud Foundry:** Supports different languages and container apps.
     ...
     #### Or implement some basic application to [Fly.io](https://fly.io/) PaaS. This requires some basic programming and IT skills:
   
   - 
   
   - ![](/Users/maria/Library/Application%20Support/marktext/images/2023-09-17-22-45-52-image.png)
...
## Codemagic.io application build
...
So, this task was not accomplished fully)

## Implement this AWS tutorial: [Build a Serverless Web Application](https://aws.amazon.com/getting-started/hands-on/build-serverless-web-app-lambda-apigateway-s3-dynamodb-cognito/)
...
13. Google Firebase: [https://www.lido.app/firebase/what-is-google-firebase](https://www.lido.app/firebase/what-is-google-firebase)
...
Setup a website providing static contents from AWS S3 bucket
